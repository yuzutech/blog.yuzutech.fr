...
Using a custom HTML5 converter is extremely powerful and should be used when you want to have full control over the converter.
For instance, when you want to build your own blog generator, or write a semantic HTML5 converter or create a converter for the latest HTML5 presentation framework.
